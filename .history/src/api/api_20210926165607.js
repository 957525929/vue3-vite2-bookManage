...
//新建权限组
export const addPermissions = (params) => $http.post("/cms/admin/group", params);
//删除权限组
export const deletePermissions = (params) => $http.delete("/cms/admin/group/" + params);
//查询一个权限组及其权限
export const findPermissions = (params) => $http.get("/cms/admin/permission/" + { params });
