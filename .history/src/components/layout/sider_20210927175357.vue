<template>
  <div style="height: 100%">
    <a-menu style="height: 100%; background: #192a5e; color: #c4c9d2" :openKeys="openKeys" v-model:selectedKeys="selectedKeys" @openChange="onOpenChange" mode="inline" @click="handleClick">
      ...
      <div v-for="a in routesData" :key="a.meta.key">
        ...
        <a-sub-menu v-if="a.children" :key="a.meta.key" :title="a.meta.title">
          <div v-for="b in a.children" :key="b.meta.key">
            ...
            <!-- 3级 -->
            <a-sub-menu v-if="b.children" :key="b.meta.key" :title="b.meta.title">
...
<script>
import { reactive, toRefs, ref } from "vue";3
