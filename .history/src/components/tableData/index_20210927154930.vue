<template>
  <a-table class="ant-table-striped" :pagination="false" size="middle" :data-source="table_config.data" rowKey="id" :rowClassName="(record, index) => (index % 2 === 1 ? 'table-striped' : null)">
    <template v-for="item in table_config.columns" :key="item.key">
