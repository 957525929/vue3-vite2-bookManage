  ...
  <div>
    ...
    <a-card>
      <a-form ref="formRef" :model="formState" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        ...
        <a-form-item label="邮箱" v-bind="validateInfos.title">
          <a-input v-model:value="author" />
        </a-form-item>
        <a-form-item label="密码" v-bind="validateInfos.title">
          <a-input v-model:value="image" />
        </a-form-item>
        <a-form-item label="确认密码" v-bind="validateInfos.title">
          <a-input v-model:value="image" />
        </a-form-item>
        <a-form-item label="选择分组" v-bind="validateInfos.title">
