        ...
        <a-form-item has-feedback label="分配权限" name="group_ids">
          <div class="detail">
            ...
            <div class="group backColor">
              <a-checkbox-group v-model:value="checkedList" :options="state.data.图书.name" />
            </div>
            <div class="group">
              <a-checkbox v-model:checked="checkAll" :indeterminate="indeterminate" @change="onCheckAllChange"> 日志 </a-checkbox>
            </div>
            <div class="group backColor">
              <a-checkbox-group v-model:value="checkedList" :options="state.data.图书" />
            </div>
          </div>
        </a-form-item>
