    ...
    const onSubmit = async () => {
      ...
      for (let i in state.arr) {
        for (let k in formState.permission_ids) {
          //  if(state.arr[i])
          console.log("i", state.arr[i]);
          console.log("k", formState.permission_ids[i]);
          if((state.arr[i]!=formState.permission_ids[k])&&(state.arr[i].length>formState.permission_ids[i].length)){
